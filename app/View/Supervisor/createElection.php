...
<div class="main-container">
    ...
    <table>
                ...
                <div id="nomiBox" style="display: none;">
                    <div class="mb-1">
                        <textarea id="nomi-description" cols="50" rows="10" name="nomi_description" placeholder="Enter description that should be displayed when self nominations.... " class="border-1 border-radius-1 w-100 px-1 py-1"></textarea>
                    </div>
                </div>
...
-->
                <div class="d-flex justify-content-between">
                    <input class="btn btn-danger w-25" type="submit" id="sbmit" value="CANCEL" onclick="goBack()">

...
<div class="main-container">
    ...
    <div class="d-flex flex-column border-primary border-radius-2 border-2 my-4 bg-white">
        <div class="position mx-1 my-1">
            ...
            <div class="noOfOptions mx-1 my-1" id="position2">
                ...
                <input type="number" name="noOfOptions" id="noOfOptions" value="1" min="1" class="border-1 border-radius-2 w-20" style="padding-left: 2%; padding-right: 1%;">
            </div>
